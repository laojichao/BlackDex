...
/**
 * Android 隐藏 API {@code android.content.pm.PackageParser} 的反射包装器（Android 5.1 Lollipop MR1 版本）。
 * <p>
 * 对应 Lollipop MR1 (API 22) 版本的 PackageParser API 签名，
 * 与 {@link PackageParserLollipop} 结构相同但针对不同 API 级别。
 */
